...
void AstarAvoid::mergeAvoidWaypoints(const nav_msgs::Path& path, int& end_of_avoid_index)
{
  ...
  // note-tianyu end_of_avoid_index以前waypoints为astar规划出的路径
  ...
  // end_of_avoid_index以后的waypoints还是基于"base_waypoints"
